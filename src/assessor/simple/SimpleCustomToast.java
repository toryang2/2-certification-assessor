...
public class SimpleCustomToast extends ToastCustomPanel {
    ...
    private void init() {
        ...
        JLabel labelProfile = new JLabel(new AvatarIcon(getClass().getResource("/assessor/images/profile_2.jpg"), 50, 50, 999));
        ...
        JButton buttonClose = new JButton(new FlatSVGIcon("assessor/icons/close.svg", 0.3f));
