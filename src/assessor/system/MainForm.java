...
import assessor.component.FormSearchButton;
import assessor.component.MemoryBar;
import assessor.component.RefreshLine;
import assessor.icons.SVGIconUIColor;
...
public class MainForm extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        JButton buttonDrawer = new JButton(new FlatSVGIcon("assessor/icons/menu.svg", 0.5f));
        buttonUndo = new JButton(new FlatSVGIcon("assessor/icons/undo.svg", 0.5f));
        buttonRedo = new JButton(new FlatSVGIcon("assessor/icons/redo.svg", 0.5f));
        buttonRefresh = new JButton(new FlatSVGIcon("assessor/icons/refresh.svg", 0.5f));
    ...
    private JPanel createFooter() {
        ...
        lbJava.putClientProperty(FlatClientProperties.STYLE, "" +
                "foreground:$Label.disabledForeground;");
        lbJava.setIcon(new SVGIconUIColor("assessor/icons/java.svg", 1f, "Label.disabledForeground"));
        panel.add(lbJava);
