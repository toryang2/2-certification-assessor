 ...
 * @author Toryang
 */
public class FormNoLandholding extends Form {
    private static final Logger logger = Logger.getLogger(FormNoLandholding.class.getName());
